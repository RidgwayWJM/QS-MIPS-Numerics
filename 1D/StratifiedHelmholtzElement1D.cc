...
void StratifiedHelmholtzElement1D::fill_in_generic_residual_contribution_strat_helmholtz(Vector<double>& residuals, DenseMatrix<double>& jacobian, const unsigned& flag)
  {
  ...
  void StratifiedHelmholtzElement1D::dinterpolated_c_ddata_strat_helmholtz(Vector<double>& s, 
  ...
  void StratifiedHelmholtzElement1D::output(ostream &outfile)	{
  ...
  unsigned StratifiedHelmholtzElement1D::self_test()
  {
	bool passed = true;
